...
module.exports = {
  ...
  "rules": {
    "indent": [                              // 缩进: https://eslint.org/docs/latest/rules/indent
      "warn",
      2,
      {
    ...
    "quotes": [                              // 单引号: https://eslint.org/docs/latest/rules/quotes
      "warn",
      "single",
    ],
    "quote-props": [
    ...
    "semi": [                                // 分号: https://eslint.org/docs/latest/rules/semi
      "warn",
      "never",
    ],
    "prefer-const": [                        // const声明: https://eslint.org/docs/latest/rules/prefer-const
      "warn",
      {
        "destructuring": "any",
